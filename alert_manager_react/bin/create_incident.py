#!/usr/bin/env python3
"""
Alert Manager React — create_incident alert action
===================================================
...
def kv_request(server_uri, session_key, path, method="GET", data=None):
    ...
    path is relative to /servicesNS/nobody/alert_manager_react/storage/collections
    """
    url = (
        f"{server_uri}/servicesNS/nobody/alert_manager_react"
